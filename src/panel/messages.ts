...
export const message: Record<Modus, string> = {
	...
	control: `<h4>Take Full Control</h4><ol><li>Start a transition</li><li>Optional: Select animations from the list below</li><li>Move freely through the timeline by moving the sliders and concentrate on selected elements and groups.</li></ol>`,
