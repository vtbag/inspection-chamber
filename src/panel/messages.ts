...
export const message: Record<Modus, string> = {
	...
	control: `<h4>Take Full Control</h4><ol><li>Start a transition</li><li>Optional: Select animations from the list below</li><li>Move freely through the timeline by moving the sliders and concentrate on selected elements and groups.</li><li>To end the inspection, click the [Exit] button in the Full Control panel or the <i>play indicator</i> ([>]) in the top left corner of the viewport.</li></ol>`,
