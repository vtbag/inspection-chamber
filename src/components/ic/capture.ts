...
function capture(
	...
	named.sort((a, b) => {
		const aPath = deriveCSSSelector(a.element) + (a.pseudoElement ? a.pseudoElement : '');
		const bPath = deriveCSSSelector(b.element) + (b.pseudoElement ? b.pseudoElement : '');
		return aPath > bPath ? -1 : aPath < bPath ? 1 : 0;
	});
	console.profileEnd("IC2");
	console.dir(named);
